...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  1 21:22:31 2026
...
def sontop(x=10):
    ...
    while True:
        ...
        if taxmin<tasodifiy_son:
            ...
            break
    print(f"Tabriklaymiz, {taxminlar}-martada topdingiz!")
    return taxminlar
...
def sontop_pc(x=10):
    ...
    while True:
        ...
        if javob == "-":
            ...
            break
    print(f"Siz o`ylagan sonni {taxminlar}- martada topdim!")
    return taxminlar
...
def play(x=10):
    ...
    while yana:
        ...
        if taxminlar_user>taxminlar_pc:
            ...
            print("Durrang!")
        yana = int(input("Yana o`ynaysizmi? Ha(10)/Yo`q(0):"))
